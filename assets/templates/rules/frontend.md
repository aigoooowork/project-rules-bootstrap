...
Required: scope, confirmed facts, execution rules, verification, related rules. Conditional: confirmed constraints. Length: 10-50 lines. Sources: observed pages, components, state, request, route, or style boundaries. Constraints: require marker-bound bodies matching Manifest text and unique one-rule confirmation records. Forbidden: backend persistence rules, framework tutorials, generic UX advice, secrets. Correct: "Route requests through the observed client module." Incorrect: "Design a beautiful interface." -->
