...
| `constraint-candidate` | A proposed or inferred prohibition, mandatory action, or exception would materially limit future work. | Never infer solely from absence or generic practice. | Keep out of canonical rules until explicitly confirmed. |
